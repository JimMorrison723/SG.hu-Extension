			...
			if( typeof localStorage['overlay_reply_to']						== 'undefined') localStorage['overlay_reply_to']					= 'true';
			if( typeof localStorage['highlight_comments_for_me']			== 'undefined') localStorage['highlight_comments_for_me']			= 'true';
			if( typeof localStorage['show_mentioned_comments']				== 'undefined') localStorage['show_mentioned_comments']				= 'true';
			if( typeof localStorage['show_mentioned_comments_in_links']		== 'undefined') localStorage['show_mentioned_comments_in_links']	= 'true';
