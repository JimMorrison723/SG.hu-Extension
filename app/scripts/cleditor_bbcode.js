...
(function ($) {
	...
	$.cleditor.convertHTMLtoBBCode = function (html) {
		...
		$.each([
			...
			// Font sizes
			[/<span class="bb-style-mini">([\s\S]*?)<\/span>/img, "[apro]$1[/apro]"],
			[/<span>([\s\S]*?)<\/span>/img, "$1"],
			[/<span class="bb-style-medium">([\s\S]*?)<\/span>/img, "[nagy]$1[/nagy]"],
			[/<span class="bb-style-large">([\s\S]*?)<\/span>/img, "[hatalmas]$1[/hatalmas]"],
			[/<span class="bb-style-xlarge">([\s\S]*?)<\/span>/img, "[brutalnagy]$1[/brutalnagy]"],

			// span color
			[/<span style="color:#ff0000">([\s\S]*?)<\/span>/img, "[szin=red]$1[/szin]"],
			[/<span style="color:#ff00ff">([\s\S]*?)<\/span>/img, "[szin=magenta]$1[/szin]"],
			[/<span style="color:#800080">([\s\S]*?)<\/span>/img, "[szin=purple]$1[/szin]"],
			[/<span style="color:#0000ff">([\s\S]*?)<\/span>/img, "[szin=blue]$1[/szin]"],
			[/<span style="color:#00ffff">([\s\S]*?)<\/span>/img, "[szin=cyan]$1[/szin]"],
			[/<span style="color:#00ff00">([\s\S]*?)<\/span>/img, "[szin=lime]$1[/szin]"],
			[/<span style="color:#008000">([\s\S]*?)<\/span>/img, "[szin=green]$1[/szin]"],
			[/<span style="color:#ffff00">([\s\S]*?)<\/span>/img, "[szin=yellow]$1[/szin]"],
			[/<span style="color:#ffa500">([\s\S]*?)<\/span>/img, "[szin=orange]$1[/szin]"],

			// span color and size
			[/<span style="color:#ff0000" class="bb-style-mini">([\s\S]*?)<\/span>/img, "[apro][szin=red]$1[/szin][/apro]"],
			[/<span style="color:#ff00ff" class="bb-style-mini">([\s\S]*?)<\/span>/img, "[apro][szin=magenta]$1[/szin][/apro]"],
			[/<span style="color:#800080" class="bb-style-mini">([\s\S]*?)<\/span>/img, "[apro][szin=purple]$1[/szin][/apro]"],
			[/<span style="color:#0000ff" class="bb-style-mini">([\s\S]*?)<\/span>/img, "[apro][szin=blue]$1[/szin][/apro]"],
			[/<span style="color:#00ffff" class="bb-style-mini">([\s\S]*?)<\/span>/img, "[apro][szin=cyan]$1[/szin][/apro]"],
			[/<span style="color:#00ff00" class="bb-style-mini">([\s\S]*?)<\/span>/img, "[apro][szin=lime]$1[/szin][/apro]"],
			[/<span style="color:#008000" class="bb-style-mini">([\s\S]*?)<\/span>/img, "[apro][szin=green]$1[/szin][/apro]"],
			[/<span style="color:#ffff00" class="bb-style-mini">([\s\S]*?)<\/span>/img, "[apro][szin=yellow]$1[/szin][/apro]"],
			[/<span style="color:#ffa500" class="bb-style-mini">([\s\S]*?)<\/span>/img, "[apro][szin=orange]$1[/szin][/apro]"],
			...
			[/<span style="color:#ff0000" class="bb-style-medium">([\s\S]*?)<\/span>/img, "[nagy][szin=red]$1[/szin][/nagy]"],
			[/<span style="color:#ff00ff" class="bb-style-medium">([\s\S]*?)<\/span>/img, "[nagy][szin=magenta]$1[/szin][/nagy]"],
			[/<span style="color:#800080" class="bb-style-medium">([\s\S]*?)<\/span>/img, "[nagy][szin=purple]$1[/szin][/nagy]"],
			[/<span style="color:#0000ff" class="bb-style-medium">([\s\S]*?)<\/span>/img, "[nagy][szin=blue]$1[/szin][/nagy]"],
			[/<span style="color:#00ffff" class="bb-style-medium">([\s\S]*?)<\/span>/img, "[nagy][szin=cyan]$1[/szin][/nagy]"],
			[/<span style="color:#00ff00" class="bb-style-medium">([\s\S]*?)<\/span>/img, "[nagy][szin=lime]$1[/szin][/nagy]"],
			[/<span style="color:#008000" class="bb-style-medium">([\s\S]*?)<\/span>/img, "[nagy][szin=green]$1[/szin][/nagy]"],
			[/<span style="color:#ffff00" class="bb-style-medium">([\s\S]*?)<\/span>/img, "[nagy][szin=yellow]$1[/szin][/nagy]"],
			[/<span style="color:#ffa500" class="bb-style-medium">([\s\S]*?)<\/span>/img, "[nagy][szin=orange]$1[/szin][/nagy]"],

			[/<span style="color:#ff0000" class="bb-style-large">([\s\S]*?)<\/span>/img, "[hatalmas][szin=red]$1[/szin][/hatalmas]"],
			[/<span style="color:#ff00ff" class="bb-style-large">([\s\S]*?)<\/span>/img, "[hatalmas][szin=magenta]$1[/szin][/hatalmas]"],
			[/<span style="color:#800080" class="bb-style-large">([\s\S]*?)<\/span>/img, "[hatalmas][szin=purple]$1[/szin][/hatalmas]"],
			[/<span style="color:#0000ff" class="bb-style-large">([\s\S]*?)<\/span>/img, "[hatalmas][szin=blue]$1[/szin][/hatalmas]"],
			[/<span style="color:#00ffff" class="bb-style-large">([\s\S]*?)<\/span>/img, "[hatalmas][szin=cyan]$1[/szin][/hatalmas]"],
			[/<span style="color:#00ff00" class="bb-style-large">([\s\S]*?)<\/span>/img, "[hatalmas][szin=lime]$1[/szin][/hatalmas]"],
			[/<span style="color:#008000" class="bb-style-large">([\s\S]*?)<\/span>/img, "[hatalmas][szin=green]$1[/szin][/hatalmas]"],
			[/<span style="color:#ffff00" class="bb-style-large">([\s\S]*?)<\/span>/img, "[hatalmas][szin=yellow]$1[/szin][/hatalmas]"],
			[/<span style="color:#ffa500" class="bb-style-large">([\s\S]*?)<\/span>/img, "[hatalmas][szin=orange]$1[/szin][/hatalmas]"],

			[/<span style="color:#ff0000" class="bb-style-xlarge">([\s\S]*?)<\/span>/img, "[brutalnagy][szin=red]$1[/szin][/brutalnagy]"],
			[/<span style="color:#ff00ff" class="bb-style-xlarge">([\s\S]*?)<\/span>/img, "[brutalnagy][szin=magenta]$1[/szin][/brutalnagy]"],
			[/<span style="color:#800080" class="bb-style-xlarge">([\s\S]*?)<\/span>/img, "[brutalnagy][szin=purple]$1[/szin][/brutalnagy]"],
			[/<span style="color:#0000ff" class="bb-style-xlarge">([\s\S]*?)<\/span>/img, "[brutalnagy][szin=blue]$1[/szin][/brutalnagy]"],
			[/<span style="color:#00ffff" class="bb-style-xlarge">([\s\S]*?)<\/span>/img, "[brutalnagy][szin=cyan]$1[/szin][/brutalnagy]"],
			[/<span style="color:#00ff00" class="bb-style-xlarge">([\s\S]*?)<\/span>/img, "[brutalnagy][szin=lime]$1[/szin][/brutalnagy]"],
			[/<span style="color:#008000" class="bb-style-xlarge">([\s\S]*?)<\/span>/img, "[brutalnagy][szin=green]$1[/szin][/brutalnagy]"],
			[/<span style="color:#ffff00" class="bb-style-xlarge">([\s\S]*?)<\/span>/img, "[brutalnagy][szin=yellow]$1[/szin][/brutalnagy]"],
			[/<span style="color:#ffa500" class="bb-style-xlarge">([\s\S]*?)<\/span>/img, "[brutalnagy][szin=orange]$1[/szin][/brutalnagy]"],
...
//		[/<img.*?src.*img\/content\/warning2.png".*?>/gmi, "[/spoiler]"],  
	...
	$.cleditor.convertBBCodeToHTML = function (code) {
		...
		$.each([
			...
			// span sizes
			[/\[apro\]([\s\S]*?)\[\/apro]/gim, '<span class="bb-style-mini">$1</span>'],
			[/\[nagy\]([\s\S]*?)\[\/nagy]/gim, '<span class="bb-style-medium">$1</span>'],
			[/\[hatalmas\]([\s\S]*?)\[\/hatalmas]/gim, '<span class="bb-style-large">$1</span>'],
			[/\[brutalnagy\]([\s\S]*?)\[\/brutalnagy]/gim, '<span class="bb-style-xlarge">$1</span>'],

			// span color
			[/\[szin=red\]([\s\S]*?)\[\/szin]/gim, '<span style="color:#ff0000">$1</span>'],
			[/\[szin=magenta\]([\s\S]*?)\[\/szin]/gim, '<span style="color:#ff00ff">$1</span>'],
			[/\[szin=purple\]([\s\S]*?)\[\/szin]/gim, '<span style="color:#800080">$1</span>'],
			[/\[szin=blue\]([\s\S]*?)\[\/szin]/gim, '<span style="color:#0000ff">$1</span>'],
			[/\[szin=cyan\]([\s\S]*?)\[\/szin]/gim, '<span style="color:#00ffff">$1</span>'],
			[/\[szin=lime\]([\s\S]*?)\[\/szin]/gim, '<span style="color:#00ff00">$1</span>'],
			[/\[szin=green\]([\s\S]*?)\[\/szin]/gim, '<span style="color:#008000">$1</span>'],
			[/\[szin=yellow\]([\s\S]*?)\[\/szin]/gim, '<span style="color:#ffff00">$1</span>'],
			[/\[szin=orange\]([\s\S]*?)\[\/szin]/gim, '<span style="color:#ffa500">$1</span>'],
