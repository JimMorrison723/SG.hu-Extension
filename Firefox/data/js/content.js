	...
	activated : function() {
		...
		$('.topichead').closest('table').each(function() {
			...
			if(!$(this).data('events')) {
				...
				{
					//Place info image
				    $(this).addClass('quick_user_info').find('td.right').before('<td class="left" nowrap><img src="data:image/png;base64' + infoIMG + '" class="ext_quick_user_info_btn"></td>');
				}
