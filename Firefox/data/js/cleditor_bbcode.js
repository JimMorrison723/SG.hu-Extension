  ...
  $.cleditor.convertHTMLtoBBCode = function(html) {
    ...
    $.each([
      [/[\r|\n]/g, ""],
		...
		[/<font size="4">([\s\S]*?)<\/font>/img, "[nagy]$1[/nagy]"],
		[/<font size="5">([\s\S]*?)<\/font>/img, "[hatalmas]$1[/hatalmas]"],
		[/<font size="6">([\s\S]*?)<\/font>/img, "[brutalnagy]$1[/brutalnagy]"],
      
		// Font color
		[/<font color="#ff0000">([\s\S]*?)<\/font>/img, "[szin=red]$1[/szin]"],
		[/<font color="#ff00ff">([\s\S]*?)<\/font>/img, "[szin=magenta]$1[/szin]"],
		[/<font color="#800080">([\s\S]*?)<\/font>/img, "[szin=purple]$1[/szin]"],
		[/<font color="#0000ff">([\s\S]*?)<\/font>/img, "[szin=blue]$1[/szin]"],
		[/<font color="#00ffff">([\s\S]*?)<\/font>/img, "[szin=cyan]$1[/szin]"],
		[/<font color="#00ff00">([\s\S]*?)<\/font>/img, "[szin=lime]$1[/szin]"],
		[/<font color="#008000">([\s\S]*?)<\/font>/img, "[szin=green]$1[/szin]"],
		[/<font color="#ffff00">([\s\S]*?)<\/font>/img, "[szin=yellow]$1[/szin]"],
		[/<font color="#ffa500">([\s\S]*?)<\/font>/img, "[szin=orange]$1[/szin]"],

		// Font color and size
		[/<font color="#ff0000" size="1">([\s\S]*?)<\/font>/img, "[apro][szin=red]$1[/szin][/apro]"],
		[/<font color="#ff00ff" size="1">([\s\S]*?)<\/font>/img, "[apro][szin=magenta]$1[/szin][/apro]"],
		[/<font color="#800080" size="1">([\s\S]*?)<\/font>/img, "[apro][szin=purple]$1[/szin][/apro]"],
		[/<font color="#0000ff" size="1">([\s\S]*?)<\/font>/img, "[apro][szin=blue]$1[/szin][/apro]"],
		[/<font color="#00ffff" size="1">([\s\S]*?)<\/font>/img, "[apro][szin=cyan]$1[/szin][/apro]"],
		[/<font color="#00ff00" size="1">([\s\S]*?)<\/font>/img, "[apro][szin=lime]$1[/szin][/apro]"],
		[/<font color="#008000" size="1">([\s\S]*?)<\/font>/img, "[apro][szin=green]$1[/szin][/apro]"],
		[/<font color="#ffff00" size="1">([\s\S]*?)<\/font>/img, "[apro][szin=yellow]$1[/szin][/apro]"],
		[/<font color="#ffa500" size="1">([\s\S]*?)<\/font>/img, "[apro][szin=orange]$1[/szin][/apro]"], 

		[/<font color="#ff0000" size="2">([\s\S]*?)<\/font>/img, "[szin=red]$1[/szin]"],
		[/<font color="#ff00ff" size="2">([\s\S]*?)<\/font>/img, "[szin=magenta]$1[/szin]"],
		[/<font color="#800080" size="2">([\s\S]*?)<\/font>/img, "[szin=purple]$1[/szin]"],
		[/<font color="#0000ff" size="2">([\s\S]*?)<\/font>/img, "[szin=blue]$1[/szin]"],
		[/<font color="#00ffff" size="2">([\s\S]*?)<\/font>/img, "[szin=cyan]$1[/szin]"],
		[/<font color="#00ff00" size="2">([\s\S]*?)<\/font>/img, "[szin=lime]$1[/szin]"],
		[/<font color="#008000" size="2">([\s\S]*?)<\/font>/img, "[szin=green]$1[/szin]"],
		[/<font color="#ffff00" size="2">([\s\S]*?)<\/font>/img, "[szin=yellow]$1[/szin]"],
		[/<font color="#ffa500" size="2">([\s\S]*?)<\/font>/img, "[szin=orange]$1[/szin]"], 

		[/<font color="#ff0000" size="4">([\s\S]*?)<\/font>/img, "[nagy][szin=red]$1[/szin][/nagy]"],
		[/<font color="#ff00ff" size="4">([\s\S]*?)<\/font>/img, "[nagy][szin=magenta]$1[/szin][/nagy]"],
		[/<font color="#800080" size="4">([\s\S]*?)<\/font>/img, "[nagy][szin=purple]$1[/szin][/nagy]"],
		[/<font color="#0000ff" size="4">([\s\S]*?)<\/font>/img, "[nagy][szin=blue]$1[/szin][/nagy]"],
		[/<font color="#00ffff" size="4">([\s\S]*?)<\/font>/img, "[nagy][szin=cyan]$1[/szin][/nagy]"],
		[/<font color="#00ff00" size="4">([\s\S]*?)<\/font>/img, "[nagy][szin=lime]$1[/szin][/nagy]"],
		[/<font color="#008000" size="4">([\s\S]*?)<\/font>/img, "[nagy][szin=green]$1[/szin][/nagy]"],
		[/<font color="#ffff00" size="4">([\s\S]*?)<\/font>/img, "[nagy][szin=yellow]$1[/szin][/nagy]"],
		[/<font color="#ffa500" size="4">([\s\S]*?)<\/font>/img, "[nagy][szin=orange]$1[/szin][/nagy]"], 

		[/<font color="#ff0000" size="5">([\s\S]*?)<\/font>/img, "[hatalmas][szin=red]$1[/szin][/hatalmas]"],
		[/<font color="#ff00ff" size="5">([\s\S]*?)<\/font>/img, "[hatalmas][szin=magenta]$1[/szin][/hatalmas]"],
		[/<font color="#800080" size="5">([\s\S]*?)<\/font>/img, "[hatalmas][szin=purple]$1[/szin][/hatalmas]"],
		[/<font color="#0000ff" size="5">([\s\S]*?)<\/font>/img, "[hatalmas][szin=blue]$1[/szin][/hatalmas]"],
		[/<font color="#00ffff" size="5">([\s\S]*?)<\/font>/img, "[hatalmas][szin=cyan]$1[/szin][/hatalmas]"],
		[/<font color="#00ff00" size="5">([\s\S]*?)<\/font>/img, "[hatalmas][szin=lime]$1[/szin][/hatalmas]"],
		[/<font color="#008000" size="5">([\s\S]*?)<\/font>/img, "[hatalmas][szin=green]$1[/szin][/hatalmas]"],
		[/<font color="#ffff00" size="5">([\s\S]*?)<\/font>/img, "[hatalmas][szin=yellow]$1[/szin][/hatalmas]"],
		[/<font color="#ffa500" size="5">([\s\S]*?)<\/font>/img, "[hatalmas][szin=orange]$1[/szin][/hatalmas]"],    

		[/<font color="#ff0000" size="6">([\s\S]*?)<\/font>/img, "[brutalnagy][szin=red]$1[/szin][/brutalnagy]"],
		[/<font color="#ff00ff" size="6">([\s\S]*?)<\/font>/img, "[brutalnagy][szin=magenta]$1[/szin][/brutalnagy]"],
		[/<font color="#800080" size="6">([\s\S]*?)<\/font>/img, "[brutalnagy][szin=purple]$1[/szin][/brutalnagy]"],
		[/<font color="#0000ff" size="6">([\s\S]*?)<\/font>/img, "[brutalnagy][szin=blue]$1[/szin][/brutalnagy]"],
		[/<font color="#00ffff" size="6">([\s\S]*?)<\/font>/img, "[brutalnagy][szin=cyan]$1[/szin][/brutalnagy]"],
		[/<font color="#00ff00" size="6">([\s\S]*?)<\/font>/img, "[brutalnagy][szin=lime]$1[/szin][/brutalnagy]"],
		[/<font color="#008000" size="6">([\s\S]*?)<\/font>/img, "[brutalnagy][szin=green]$1[/szin][/brutalnagy]"],
		[/<font color="#ffff00" size="6">([\s\S]*?)<\/font>/img, "[brutalnagy][szin=yellow]$1[/szin][/brutalnagy]"],
		[/<font color="#ffa500" size="6">([\s\S]*?)<\/font>/img, "[brutalnagy][szin=orange]$1[/szin][/brutalnagy]"],
  ...
  $.cleditor.convertBBCodeToHTML = function(code) {
    ...
    $.each([
      [/\r/g, ""],
		...
		[/\[nagy\]([\s\S]*?)\[\/nagy]/gim, '<font size="4" >$1</font>'],
		[/\[hatalmas\]([\s\S]*?)\[\/hatalmas]/gim, '<font size="5" >$1</font>'],
		[/\[brutalnagy\]([\s\S]*?)\[\/brutalnagy]/gim, '<font size="6" >$1</font>'],

		// Font color
		[/\[szin=red\]([\s\S]*?)\[\/szin]/gim, '<font color="#ff0000">$1</font>'],
		[/\[szin=magenta\]([\s\S]*?)\[\/szin]/gim, '<font color="#ff00ff">$1</font>'],
		[/\[szin=purple\]([\s\S]*?)\[\/szin]/gim, '<font color="#800080">$1</font>'],
		[/\[szin=blue\]([\s\S]*?)\[\/szin]/gim, '<font color="#0000ff">$1</font>'],
		[/\[szin=cyan\]([\s\S]*?)\[\/szin]/gim, '<font color="#00ffff">$1</font>'],
		[/\[szin=lime\]([\s\S]*?)\[\/szin]/gim, '<font color="#00ff00">$1</font>'],
		[/\[szin=green\]([\s\S]*?)\[\/szin]/gim, '<font color="#008000">$1</font>'],
		[/\[szin=yellow\]([\s\S]*?)\[\/szin]/gim, '<font color="#ffff00">$1</font>'],
		[/\[szin=orange\]([\s\S]*?)\[\/szin]/gim, '<font color="#ffa500">$1</font>'],
